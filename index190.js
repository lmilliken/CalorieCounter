...
Create a variable name `maxCalories` and set it equal to the document element with the id of `female`.  This is similar to how you reference the element with the `id` of `calorie-form` at the beginning of this file.
