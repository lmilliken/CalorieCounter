...
To determine if this is a calorie surplus or deficit, create a variable name `surplusOrDeficit` to determine if the difference is positive (`difference > 0`).  If it is positive,`surplusOrDeficit` should be set equal to `Surplus`, and `Deficit` if negative. We will use this `surplusOrDeficit` variable later when printing the output.
